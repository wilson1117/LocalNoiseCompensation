...
class ConvNet(nn.Module):
    def __init__(self, num_classes=10, attack_test=False, grayscale=False, input_shape=(32, 32)):
        super(ConvNet, self).__init__()
        self.conv1_1 = nn.Conv2d(1 if grayscale else 3, 32, 3, 1)
        ...
        self.n_size = self._get_conv_output((1 if grayscale else 3, 32, 32))
